...
const DirectorMessage = () => {
  ...
  return (
    <section className="py-6 bg-gradient-to-b from-blue-50 to-white font-poppins dark:from-gray-800 dark:to-gray-900">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6">
              <div className="mb-4">
                <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-2 text-center">DGP's Message</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6">
              <div className="mb-4">
                <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-2 text-center">Director's Message</h3>
                <div className="flex items-center space-x-4 mb-4">
                  <img 
