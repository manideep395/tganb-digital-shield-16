...
const Header = () => {
  ...
  return (
    <header className="bg-white shadow-lg border-b border-darkslategrey-600 sticky top-0 z-50 font-poppins">
      ...
      <div className="bg-gradient-to-r from-green-900 via-darkslategrey-900 to-blue-900 text-white py-3 md:py-4">
        <div className="container mx-auto px-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <img 
              src="/uploads/cfe052e4-2276-4a1d-b6af-bc0ad7c3ccd4.png" 
              alt="TG ANB Logo" 
              className="h-16 w-16 md:h-20 md:w-20 rounded-full border border-white/30"
            />
            <div className="h-8 w-px bg-white/30 hidden md:block"></div>
            <img 
              src="/uploads/37f408d2-9357-4e1c-af91-05f171f00af2.png" 
              alt="Government of Telangana" 
              className="h-14 w-14 md:h-20 md:w-20 rounded-full border border-white/30"
            />
          </div>
          
          <div className="text-center flex-1">
            <h1 className="text-lg md:text-4xl font-bold font-poppins tracking-wide">
          ...
          <div className="hidden md:flex flex-col items-end space-y-2">
            <div className="flex items-center space-x-2">
              <div 
                className="flex items-center space-x-1 bg-red-600 px-3 py-1 rounded-full text-sm font-bold cursor-pointer hover:bg-red-700 transition-colors"
              ...
              <div 
                className="flex items-center space-x-1 bg-green-600 px-3 py-1 rounded-full text-sm font-medium cursor-pointer hover:bg-green-700 transition-colors"
            ...
            <div 
              className="flex items-center space-x-1 text-sm text-darkslategrey-200 cursor-pointer hover:text-white transition-colors"
              onClick={handleEmail}
            >
            ...
            <div className="flex space-x-2 items-center">
              ...
              <button 
                ...
                className="flex items-center space-x-1 bg-gray-700 hover:bg-gray-600 px-3 py-1 rounded text-sm font-medium transition-colors"
                title="Admin Login"
              >
      ...
      {/* Main Navigation - Increased size */}
      <nav className="bg-gradient-to-r from-blue-50 via-white to-blue-50 py-2">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            {/* Desktop Navigation */}
            <div className="hidden lg:flex space-x-2 justify-center flex-1">
              {menuItems.map((item, index) => (
                <div key={index} className="relative group">
                  <button 
                    className={`text-sm font-medium transition-all duration-200 py-2 px-3 rounded whitespace-nowrap flex items-center gap-1 ${
                      item.href === '/' 
              ...
              <button 
                ...
                className="text-sm font-medium transition-all duration-200 py-2 px-3 rounded whitespace-nowrap text-white bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 font-bold shadow-lg"
              >
                T-RISING.AI
              </button>
            </div>

            {/* Mobile menu with WhatsApp integration */}
            {isMenuOpen && (
